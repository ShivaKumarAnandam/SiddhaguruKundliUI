      ...
      <div className="container">
        ...
        <div className="nk-card">
          ...
          <form className="nk-form" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn nk-submit" disabled={loading}>{loading ? 'Calculating...' : 'Get Weekly Horoscope'}</button>
          </form>
        </div>
        ...
        {result && (
          <div className="fh-results" ref={resultRef}>
            ...
            <div className="fh-person-bar">
              ...
              <span>{result.input_details.date_from} to {result.input_details.date_to}</span>
              <span className="fh-person-sep">·</span>
            ...
            {currentDay && (
              <div className="fh-summary-card">
                ...
                <div className="fh-chips">
                  <Chip label="Nakshatra" value={currentDay.nakshatra} />
                  <Chip label="Rasi" value={currentDay.rasi} />
                  <Chip label="Tithi" value={currentDay.tithi} />
                  <Chip label="Yoga" value={currentDay.yoga} />
                  <Chip label="Karana" value={currentDay.karana} />
                </div>
              </div>
            )}
            ...
            {currentDay && (
              <div className="fh-predictions">
                {['weekday','nakshatra','rasi','tithi','karana','yoga'].map(key => {
                  const pred = currentDay.predictions[key]
                  if (!pred) return null
                  const icons = { weekday:'📅', nakshatra:'⭐', rasi:'♎', tithi:'🌙', karana:'🔱', yoga:'🕉️' }
                  return (
